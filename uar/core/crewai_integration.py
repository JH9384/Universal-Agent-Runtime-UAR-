    ...
    def assign_task_to_role(self, task_id: str, role: AgentRole):
        ...
        for agent in self.agents.values():
            if agent.role == role and agent.active:
                ...
                logger.info(f"Task {task_id} assigned to {agent.agent_id} (role: {role.value})")
                return
    ...
    async def execute_workflow(
        ...
        while len(executed) < len(task_ids):
            ...
            if not progress:
                ...
                logger.error(f"Cannot resolve dependencies for tasks: {pending}")
                break
        ...
        return {
            ...
            "status": "completed" if len(executed) == len(task_ids) else "partial",
        }
...
def create_standard_agent(
    ...
    role_configs = {
        ...
        AgentRole.ANALYST: {
            ...
            "backstory": "You are a skilled analyst with expertise in data interpretation",
        },
        AgentRole.WRITER: {
            "description": "Writes and edits content",
            "backstory": "You are a professional writer with excellent communication skills",
        },
        AgentRole.REVIEWER: {
        ...
        AgentRole.PLANNER: {
            ...
            "backstory": "You are a strategic planner with strong organizational skills",
        },
        AgentRole.EXECUTOR: {
        ...
        AgentRole.COORDINATOR: {
            ...
            "backstory": "You are an effective coordinator who ensures smooth collaboration",
        },
    }
