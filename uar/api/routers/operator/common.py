...
def _entity_retention_health() -> Dict[str, Any]:
    """Return operator metadata entity discovery and retention health."""
    stores = {
    ...
    result: Dict[str, Any] = {
        "metadata_backend": {
            ...
            "delete_metadata": has_delete,
        },
        "entities": {},
    }
    for name, entity_store in stores.items():
        try:
            items = entity_store.load_all()
