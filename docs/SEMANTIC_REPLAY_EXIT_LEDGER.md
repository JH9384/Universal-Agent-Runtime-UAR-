...
| Concurrent/stochastic overhead envelope | PASS | Seed `8191`: 1,600 paired runs across greedy-wide and DAG-diamond workloads at concurrency 1/4/16/32. Zero projection/result/integrity drift; worst p95 ratio 1.0086, p99 ratio 1.0781, throughput retention 0.9948, order JSD 0.0015 bits, and order TV 0.0309. | Retain the 200-sample-per-stratum confirmatory workflow gate; thresholds remain unchanged |
